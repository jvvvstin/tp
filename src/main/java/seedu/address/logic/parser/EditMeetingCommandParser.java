...
public class EditMeetingCommandParser implements Parser<EditMeetingCommand> {
    ...
    public EditMeetingCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_PERSON_INDEX, PREFIX_MEETING_INDEX, PREFIX_MEETING_INDEX,
                PREFIX_VENUE, PREFIX_WHEN) || !argMultimap.getPreamble().isEmpty()) {
