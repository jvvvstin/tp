...
public class ParserUtilSecondTest {
    ...
    public void parseParametersAndLabels_emptyString_returnEmptyList() {
        assertEquals(new ArrayList<>(), ParserUtil.parseParametersAndLabels("", false));
    }
    ...
    public void parseParametersAndLabels_validInput_returnCorrectList() {
        ...
        assertEquals(correctList, ParserUtil.parseParametersAndLabels(input, false));
    }
    ...
    public void parseParametersAndLabelsCompulsoryLabel_validInput_returnCorrectList() {
        String input = "TEST PARAMETER 1 (L a b e l 1)";
        List<String> correctList = new ArrayList<>(List.of("TEST PARAMETER 1", "(L a b e l 1)"));
        assertEquals(correctList, ParserUtil.parseParametersAndLabels(input, true));
    }

    @Test
    public void parseParametersAndLabels_extraSpaces_returnEmptyList() {
        String input = "TEST PARAMETER 1  (L a b e l 1) TEST PARAMETER 2 (L a b e l 2)";
        assertEquals(new ArrayList<>(), ParserUtil.parseParametersAndLabels(input, false));
    }
    ...
    @Test
    public void parseParametersAndLabels_extraSpaces3_returnEmptyList() {
    ...
    @Test
    public void parseParametersAndLabelsCompulsoryLabel_incorrectFormat_returnEmptyList() {
        String input = "TEST PARAMETER 1";
        assertEquals(new ArrayList<>(), ParserUtil.parseParametersAndLabels(input, true));
    }
}
